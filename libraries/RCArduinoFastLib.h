...
//#define MORE_SERVOS_PLEASE 1  //uncommented if ESC on separate part
...
#define RC_CHANNEL_OUT_COUNT 6 //for 4 servos = 5. For 4 servos + 1 esc = 6
...
#define RCARDUINO_SERIAL_SERVO_MAX 2400
